...
from reid.trainers import CoTrainerAsy, CoTrainerAsy4
from reid.trainers_meannet import CoTrainerAsyMean_4model 
...
sys.stdout = Logger("./LOG/MCN_4_mean/D2M/print.txt") 
...
def main(args):
    ...
    optims = [optimizer, coOptimizer, co2Optimizer, co3Optimizer]
