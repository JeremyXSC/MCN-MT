...
class DukeMTMC(Dataset):
    #url = 'https://drive.google.com/uc?id=0B0VOCNYh8HeRdnBPa2ZWaVBYSVk'https://drive.google.com/open?id=1jjE85dRCMOgRtvJ5RQV9-Afs-2_5dY3O
    url = 'https://drive.google.com/open?id=1jjE85dRCMOgRtvJ5RQV9-Afs-2_5dY3O'
    ...
    def download(self):
        ...
        if osp.isfile(fpath) and \
            ...
            raise RuntimeError("{},Please download the dataset manually from {} "
                               "to {}".format(fpath,self.url, fpath))
